...
namespace UltimateCC
{
    public static class EssentialPhysics
    {
        ...
        public static void GroundCheck(PlayerMain player, PlayerData playerData)
        {
           ...
           RaycastHit2D[] _hits = Physics2D.CircleCastAll(playerData.Physics.GroundCheckPosition, player.CapsuleCollider2D.size.x / 2 * Mathf.Abs(player.transform.localScale.x) + _offset, -player.transform.up, 0.5f, playerData.Physics.GroundLayerMask);
